...
class reactGAT_old(nn.Module):
    ...
    def __init__(self,
        ...
        super(reactGAT_old, self).__init__()
...
class reactGAT_noG(nn.Module):
    ...
    def __init__(self,
        ...
        super(reactGAT_noG, self).__init__()
...
class reactGAT_noC(nn.Module):
    ...
    def __init__(self,
        ...
        super(reactGAT_noC, self).__init__()
...
class reactGAT_noboth(nn.Module):
    ...
    def __init__(self,
        ...
        super(reactGAT_noboth, self).__init__()
